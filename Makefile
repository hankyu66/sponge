...
PROJECT_NAME := "github.com/hankyu66/sponge"
PKG := "$(PROJECT_NAME)"
...
install:
	...
	go install github.com/hankyu66/sponge/cmd/protoc-gen-go-rpc-tmpl@latest
...
graph:
	...
	go-callvis -skipbrowser -format=svg -nostd -file=serverNameExample_mixExample github.com/hankyu66/sponge
