...
if [ -f "${DOCKERFILE_PATH}/grpc_health_probe" ]; then
	...
	configFileCode = `// code generated by https://github.com/hankyu66/sponge

package config

import (
	"github.com/hankyu66/sponge/pkg/conf"
)
...
`
	...
	configFileCcCode = `// code generated by https://github.com/hankyu66/sponge
